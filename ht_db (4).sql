...
CREATE TABLE `booking_details` (
  ...
  `book_for_work` int(1) NOT NULL,
  `book_title` varchar(5) NOT NULL,
  `book_fname` varchar(30) NOT NULL,
  `book_lname` varchar(30) NOT NULL,
  `departure_date` date NOT NULL,
  `arrival_date` date NOT NULL,
  `book_cc` int(11) NOT NULL,
  `book_num` bigint(20) NOT NULL,
  `book_mail` varchar(100) NOT NULL,
  `book_infant` int(1) NOT NULL,
  `book_child` int(1) NOT NULL,
  `book_adult` int(1) NOT NULL,
...
CREATE TABLE `hotel_master` (
  ...
  `hotel_add_url` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `hotel_master` (`hotel_id`, `package_id`, `hotel_name`, `hotel_address`, `hotel_night`, `hotel_price`, `hotel_img`, `hotel_available`, `hotel_add_url`) VALUES
(1, 3, 'Prince Residency', 'Mehra Gaun, Bhimtal ,Bhowali Road, Bhimtal, District, Nainital , 263136', 2, 10000, '11.jpg', 1, 'https://g.page/the-prince-residency'),
(2, 4, ' Statue Of Unity Eco Camp', 'sou eco camp, Akteshwar opp Indian oil petrol pump, Garudeshwar, Narmada, Gujarat 393151, India., 393151 Akteshwar, India', 1, 3000, 'h1.jpg', 0, 'https://g.page/souecocamp'),
(3, 4, 'Tent City Narmada', 'Tent City Narmada, Dyke -3, Sardar Sarovar Dam Site, Kevadiya, 393151 Kevadia, India ', 2, 7000, 'h2.jpg', 1, 'https://g.page/TentCityNarmada'),
(4, 5, 'The Fern Residency, Bhuj', 'Bhuj Madhapar Highway Plot No. 14 A , 14 B 15, Bhuj 370020 India', 4, 3597, 'h3.jpg', 1, 'https://goo.gl/maps/unqS4723FNbafXWr8'),
(5, 5, 'Regenta Resort Bhuj', 'Gmdc House Opp Hill Garden GMDC House, Bhuj 370001 India', 3, 2836, 'h4.jpg', 1, 'https://goo.gl/maps/CvPFYLYoatbU3mLr6'),
(6, 5, 'Seven Sky Clarks Exotica', 'Seven Sky Clarks Exotica, Airport Ring Road, Bhuj 370001 India', 2, 2500, 'h5.jpg', 0, 'https://goo.gl/maps/e1FXBwUQemfrWCCJA'),
(7, 6, 'Chokhi Dhani - The Palace Hotel', ' Plot No.415, Barmer Road, Indira Colony, Jaisalmer, India, 345001', 2, 3275, 'h6.jpg', 1, 'https://goo.gl/maps/bXeTmyPQ52h7L4jF7'),
(8, 6, 'Boutique Helsinki ', 'Boutique Helsinki,Bera Road, Postal Colony, Jaisalmer, India, 345001', 3, 4500, 'h7.jpg', 1, 'https://g.page/boutique-helsinki?share'),
(9, 6, 'WelcomHeritage Mohangarh Fort', 'Jaisalmer Road, Shri Mohangarh - 345003, District - Jaisalmer, Rajasthan, INDIA, 345003 Jaisalmer, India', 1, 6720, 'h8.jpg', 1, 'https://g.page/ShriMohangarhFort?share');
